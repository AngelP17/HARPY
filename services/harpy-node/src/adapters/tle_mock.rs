...
impl TleMockProvider {
    ...
    fn generate_satellites(&self, count: usize) -> Vec<TrackDelta> {
        ...
        let orbits = [
            ("ISS", 51.6, 408000.0, 90.0 * 60.0),
            ("GPS", 55.0, 20200000.0, 12.0 * 3600.0),
            ("Starlink", 53.0, 550000.0, 95.0 * 60.0),
        ];
        ...
        for i in 0..count {
            ...
            let phase =
                (ts as f64 / 1000.0) % period / period * 2.0 * std::f64::consts::PI;
